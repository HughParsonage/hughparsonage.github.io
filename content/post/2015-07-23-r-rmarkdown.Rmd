...
## Smoothed chloropleth
To smooth chloropleth, you can use the following function.
(As you can see, the function is still in development.)

```{r smoothed-chloropleth, fig.width=10}
y <- smooth_shapefile(shapefile = SA2_2011,
                      data_by_id = ERP_by_SA2,
                      id = "SA2_MAIN11",
                      var2smooth = "Value",
                      coalesce.to = as.integer(0L), 
                      k = 10)
